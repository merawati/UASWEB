...
<section class="BERITA bg-light py-3">
  ...
  <img src="assets/images/PAS.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">PAS 2020</h5>
    <p class="card-text">3 Desember 2020</p>
    <a href="#" class="btn btn-primary">Go somewhere</a>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img src="assets/images/merdeka.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Wanda Nurhidayah</h5>
    <p class="card-text">28 November 2020</p>
    <a href="#" class="btn btn-primary">Go somewhere</a>
  </div>
      </div>
  <div class="card" style="width: 18rem;">
  <img src="assets/images/section.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Aluna Juara Nasyid</h5>
    <p class="card-text">28 November 2020</p>
    <a href="#" class="btn btn-primary">Go somewhere</a>
  </div>
  </div>
<div class="card" style="width: 18rem;">
  <img src="assets/images/radio.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">SMANDAK Radio</h5>
    <p class="card-text">23 Oktober 2020</p>
    <a href="#" class="btn btn-primary">Go somewhere</a>
  </div>
  </div>
    <div class="card" style="width: 18rem;">
  <img src="assets/images/muri.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">MURI 1001 Tumpeng</h5>
    <p class="card-text">10 September 2020</p>
    <a href="#" class="btn btn-primary">Go somewhere</a>
  </div>
  </div>
  <div class="card" style="width: 18rem;">
  <img src="assets/images/Geo.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Zahra Vita Nursaibah</h5>
    <p class="card-text">7 September 2020</p>
    <a href="#" class="btn btn-primary">Go somewhere</a>
  </div>
  </div>
      </div>
